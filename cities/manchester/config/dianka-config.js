...
var config = {
   ...
   // BEGIN CHAPTERS
    chapters: [{
            ...
            description: '<b>Location:</b> Manchester </br> <b>Date:</b> Tuesday 11/02/2021 </br> <b>Platform:</b> Deliveroo & Uber Eats </br> </br> <b></b> In her early 30s, Dianka is one of the few women doing food deliveries in Manchester. Originally from an Eastern European country, which she left a few years ago, Dianka got a postgraduate degree but couldn’t make use of it when she arrived in the UK. Instead, she’s been doing warehouse, cleaning and hospitality jobs for which she was often paid less than the minimum wage. While she initially started doing deliveries on an e-bike as a side job, it quickly became a full-time enterprise out of necessity. It was both the Covid pandemic and family circumstances which forced her into a more flexible job. As many other couriers, she’s ‘multiapping’, doing Deliveroo and Uber Eats at the same time in order to earn enough money. While the delivery money is good to cover for everyday expenses, being a woman comes at a hefty price: she often receives unwarranted attention from men; often from her colleagues at work. As a result, she carries a pepper spray with her: a ‘present’ she’s received from a friend. Outside work, she loves nature and spends as much time as she can in one of the many parks in Manchester.</br> <h3 style="text-align:center"> Art by <a target="_blank" href="https://oanalohan.ultra-book.com/">Oana Lohan</a> </h3>',
            location: {},
            onChapterEnter: [],
            onChapterExit: []
        },
        ...
        },     
        {
            ...
            audio: '../../riders/audio/Dianka/9.m4a',
