...
var config = {
   ...
   // BEGIN CHAPTERS
    chapters: [{
            ...
            description: '<b>Location:</b> Manchester </br> <b>Date:</b> Wednesday 03/03/2021 </br> <b>Platform:</b> Deliveroo, Just Eat & Uber Eats </br> </br> At 21, Hazeem moved from Pakistan to Manchester where he got his first job as food courier for Just Eat and Uber Eats. He started on an e-bike, before upgrading to a motorbike. The new vehicle allows him to be faster but, as he explained, he  got the motoribike because he was frustrated to see that motorised vehicles were prioritised for orders over cycles and e-bikes, without notice or explanation. Together with his dad, they run four accounts in total and sometimes they even work together using his dad`s car. Being motorised allows them to be more efficient, to work more hours and to ride more kilometres than cyclists. Unfortunately, it also means that they are often pushed to travel far away from where they live in Manchester. The money they earn running four account helps them sustain his mother (who doesn’t speak English) and three other minor sisters. However, Hazeem is concerned that another account suspension - as the one described below - is imminent: "It`s happening with a lot of couriers these days, so you might be the next in the queue" </br> <h3 style="text-align:center"> Art by <a target="_blank" href="https://josesherwood.com/">José Sherwood González</a> </h3>',
            location: {},
            onChapterEnter: [],
            onChapterExit: []
        },
