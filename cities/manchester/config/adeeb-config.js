...
var config = {
   ...
   // BEGIN CHAPTERS
    chapters: [{
            ...
            description: '<b>Location:</b> Manchester </br> <b>Date:</b> Thursday 21/01/2021 </br> <b>Platform:</b> Deliveroo & Uber Eats </br> </br> 28 years old Adeeb is riding an e-bike and ‘multiapping’ for both Deliveroo and Uber Eats: sometimes one is busier than the other, other times he can even deliver two orders at the same time for both platforms. Born in Pakistan, he moved to London to pursue his undergrad degree in Business. He dropped university when his father unexpectedly died. At that point he moved to Manchester, got married and now has a 3-month-old son who often keeps him awake at night. After a few other jobs in supermarkets and hotels, he started doing deliveries in October 2019, a job that gives him more flexibility than the previous ones. He enrolled just before the pandemic, when there were fewer couriers and the pay was still good. Back then using one single app was enough to earn a living. Despite putting in more hours for less money than a year ago and being the breadwinner of his household, Adeeb hopes that in one year he will have enough money to open a burger place, together with other Pakistani friends. In January 2021, I followed him at work in the cold rain in what he described as the worst day at work so far. </br> </br> <h3 style="text-align:center"> Art by <a target="_blank" href="https://www.instagram.com/ionut_dulamita/"">Ionuț Dulămiță</a> </h3>',
            location: {},
            onChapterEnter: [],
            onChapterExit: []
        },
