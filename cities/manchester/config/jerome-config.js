...
var config = {
    ...
    chapters: [{
        ...
        },
        {
            ...
            description: '<a href="Jerome1.txt"> Read Transcript </a> ',
            location: {},
            earnings: '15.32',
            onChapterEnter: [],
            onChapterExit: []
        },
        {
            ...
            description: '<a href="Jerome2.txt"> Read Transcript </a> ',
            location: {},
            earnings: '22.86',
            onChapterEnter: [],
            onChapterExit: []
        ...
        },
        {
            ...
            description: '<a href="Jerome3.txt"> Read Transcript </a> ',
            location: {},
            earnings: '25.97',
            onChapterEnter: [],
            onChapterExit: []
        },
        {
            ...
            description: '<a href="Jerome4.txt"> Read Transcript </a> ',
            earnings: '30.15',
            location: {},
            onChapterEnter: [],
            onChapterExit: []
        ...
        // BREAK
        {
            ...
            description: '<a href="Jerome5.txt"> Read Transcript </a> ',
            earnings: '30.15',
            location: {},
            onChapterEnter: [],
            onChapterExit: []
        ...
        // END BREAK        
        {
            ...
            description: '<a href="Jerome6.txt"> Read Transcript </a> ',
            earnings: '34.39',
            location: {},
            onChapterEnter: [],
            onChapterExit: []
        ...
        },
        {
            ...
            description: '<a href="Jerome7.txt"> Read Transcript </a> ',
            earnings: '39.57',
            location: {},
            onChapterEnter: [],
            onChapterExit: []
        },
        {
            ...
            description: '<a href="Jerome8.txt"> Read Transcript </a> ',
            earnings: '46.82',
            location: {},
            onChapterEnter: [],
            onChapterExit: []
        ...
        },
        {
            ...
            description: '<a href="Jerome9.txt"> Read Transcript </a> ',
            earnings: '49.79',
            location: {},
            onChapterEnter: [],
            onChapterExit: []
