...
var config = {
   ...
   // BEGIN CHAPTERS
    chapters: [{
            ...
            description: '<b>Location:</b> Lyon </br> <b>Date:</b> Tuesday 2022-09-27 </br> <b>Platform:</b> Uber Eats </br> </br> Born and raised in Banjul, the Gambia, 23 years old Jacob smiles and tells me that, after all, he is still young and optimistic about the future. It is difficult to picture this against the backdrop of his dangerous, three-year long journey across the Mediterranean first and then the Alps. He arrived in France from Italy through the mountains and relied on the stars in the sky to find his way to Briançon in a dark September night in 2018. When I met him in the autumn of 2022, Jacob just had his asylum claim rejected and was struggling to hold onto a rented Uber Eats account. Account renting is never a winning game, yet it is a common practice amongst platform food couriers in France, where more than half are undocumented migrants and do not have access to the labour market. Jacob pays 130 euros a week for an account he can lose at any time and for which he needs to meet almost daily with the owner: ‘Uber Eats asks for facial recognition, so I need to cycle 7 km from Guillotière to Vénissieux to get a selfie from him’. When we met at a squat in Guillotière, where he stops to warm up and charge batteries, Jacob sounded resolute: ‘I don’t give up yet. I still have the courage and the confidence that I will have documents here. But nobody knows, only God knows’. </br> </br> <h3 style="text-align:center"> Art by <a target="_blank" href="https://www.instagram.com/ionut_dulamita/"">Ionuț Dulămiță</a> </h3>',
            location: {},
            onChapterEnter: [],
            onChapterExit: []
        },
        {
            ...
            description: '<a target="_blank" href="../../riders/transcript/Jacob.txt"> Read Transcript </a> ',
            location: {},
            earnings: '€0',
            onChapterEnter: [],
            onChapterExit: []
