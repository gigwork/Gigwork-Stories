...
var config = {
   ...
   // BEGIN CHAPTERS
    chapters: [{
        ...
        {
            id: 'drive-slide-2',
            title: '18.01: This doesn’t exist not even in Morocco',
